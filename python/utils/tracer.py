...
class Tracer(dict):
    def __init__(self):
        ...
        self['dead_nodes'] = ('Dead nodes', rounds_label, [], 1, 0)
        if cf.TRACE_ENERGY:
            self['energy_left'] = ('Energy (J)', rounds_label, [], 1, 0)
            self['energy_consumed'] = ('Energy Consumed(J)', rounds_label, [], 1, 0)

        self['first_depletion'] = ('First depletion', rounds_label, [], 0, 0)
        self['30per_depletion'] = (
            '30 percent depletion', rounds_label, [], 0, 0)
